...
export const getClipOrigin = (image, cw, ch, orientation) => {
	...
	switch (parseInt(orientation, 10)) {
		case 2:
			return setOrigin(abs(w0 - cw), 0);
		case 3:
			return setOrigin(abs(w0 - cw), abs(h0 - ch));
		case 4:
			return setOrigin(0, abs(h0 - ch));
		case 5:
			return setOrigin(0, 0);
		case 6:
			return setOrigin(0, abs(h0 - cw));
		case 7:
			return setOrigin(abs(w0 - ch), abs(h0 - cw));
		case 8:
			return setOrigin(abs(w0 - ch), 0);
		default:
			return setOrigin(0, 0);
	}
};
